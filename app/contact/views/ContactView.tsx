        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <section>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-neutral-200 space-y-4">
              ...
              <p className="text-body text-neutral-700 leading-relaxed">
                Jeune, j&apos;ai baigné avec une partie de ma famille vignerons
                à Saint-Émilion en grand cru depuis 1750 de père en fils.
                Château Brun, famille Brun.
              </p>

              <p className="text-body text-neutral-700 leading-relaxed">
                Plus tard j&apos;ai créé 2 clubs œnologie et travaillé dans une
                cave à vin événementiel pendant 5 ans pour financer mes études
                d&apos;ingénieurs.
              </p>
              ...
              <p className="text-body text-neutral-700 leading-relaxed">
                ...
                Beaumarchais Paris 3ème pendant 7 ans (800 références de vins en
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-neutral-200 space-y-6">
              <div>
                ...
                <p className="text-body text-neutral-700 leading-relaxed mb-4">
                  N&apos;hésitez pas à me contacter pour toute question sur mes
                  sélections, pour organiser une dégustation ou simplement pour
                  échanger sur l&apos;univers du vin.
                </p>
                <div className="space-y-2 text-sm text-neutral-600">
                  <p>
                    <span className="font-medium">Email :</span>
                    <a
                      href="mailto:contact@caviste-personnel.fr"
                      className="text-primary-600 hover:text-primary-700 ml-2"
                    >
                      contact@caviste-personnel.fr
                    </a>
                  </p>
                  <p>
              ...
              <div>
                ...
                <p className="text-sm text-neutral-600">
                  Livraison possible dans toute la France métropolitaine. Délais
                  et modalités adaptés selon la région.
                </p>
              </div>
            </div>
