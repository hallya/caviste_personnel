...
export const metadata: Metadata = {
  ...
  description: "Contactez Edouard pour vos besoins en vins d'exception. Caviste personnel passionné, spécialiste des vignerons français et conseils personnalisés.",
  openGraph: {
    title: "Contact & À propos - Edouard, Caviste personnel",
    description: "Contactez Edouard pour vos besoins en vins d'exception. Caviste personnel passionné, spécialiste des vignerons français et conseils personnalisés.",
