...
export function productMatchesTags(product: { tags: string[] }, selectedTags: string[]): boolean {
...
export function productMatchesSearch(product: { title: string; tags: string[] }, searchQuery: string): boolean {
...
export function sortProducts<T extends { title: string; price?: string | null }>(
  products: T[],
  sortBy: 'name' | 'price',
  sortOrder: 'asc' | 'desc'
): T[] {
