import { PageHeader } from "@pkg/design-system";
        ...
        <div className="container mx-auto px-4 py-12 max-w-4xl">
          <header className="text-center mb-12">
            ...
            <p className="text-body text-neutral-700 text-lg leading-relaxed max-w-3xl mx-auto">
              Développez votre palais et votre connaissance des vins avec des
              formations personnalisées. Découverte des terroirs, techniques de
              ...
              <div className="space-y-6">
                <div className="bg-white p-6 rounded-lg shadow-sm border border-neutral-200">
                  ...
                  <p className="text-body text-neutral-600 mb-4">
                    Apprenez les bases de la dégustation : analyse visuelle,
                    olfactive et gustative. Développez votre vocabulaire
                    œnologique.
                  </p>
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border border-neutral-200">
                  ...
                  <p className="text-body text-neutral-600 mb-4">
                    Voyage à travers les régions viticoles françaises. Comprenez
                    l&apos;influence du terroir sur le caractère des vins.
                  </p>
                  <ul className="text-sm text-neutral-600 space-y-1">
                    <li>• Durée : 3h</li>
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border border-neutral-200">
                  ...
                  <p className="text-body text-neutral-600 mb-4">
                    Maîtrisez l&apos;art des accords. Apprenez à associer vins
                    et mets pour sublimer vos repas.
                  </p>
                  <ul className="text-sm text-neutral-600 space-y-1">
                    <li>• Durée : 2h30</li>
                    <li>• Groupe : 2-6 personnes</li>
                ...
                <div className="space-y-4">
                  ...
                  {isSubmitting && (
                    <p id="submitting-status" className="sr-only">
                      Le formulaire est en cours d&apos;envoi, veuillez
                      patienter
                    </p>
                  )}
                </div>
