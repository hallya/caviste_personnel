...
const mockUseCollectionFilters = useCollectionFilters as jest.MockedFunction<
  typeof useCollectionFilters
>;
  ...
  return function MockPopupView(props: {
    ...
    return (
      <div data-testid="popup-view">
        ...
        <button data-testid="load-more-button" onClick={props.onLoadMore}>
          Load More
        </button>
        <input
        ...
        <span data-testid="has-active-filters">
          {String(props.hasActiveFilters)}
        </span>
...
describe("PopupContainer", () => {
  ...
  describe("Container Logic", () => {
    ...
    it("should pass correct props to PopupView", () => {
      ...
      expect(screen.getByTestId("has-active-filters")).toHaveTextContent(
        "false",
      );
    });
