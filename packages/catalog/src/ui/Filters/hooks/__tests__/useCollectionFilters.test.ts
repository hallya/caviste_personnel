...
const mockUseProductFilters = useProductFilters as jest.MockedFunction<
...
describe("useCollectionFilters", () => {
  ...
  describe("Basic Functionality", () => {
    ...
    it("should return correct filter methods from useProductFilters", () => {
      ...
      expect(result.current.clearFilters).toBe(
        mockProductFiltersReturn.clearFilters,
      );
      expect(result.current.setSearchQuery).toBe(
        mockProductFiltersReturn.setSearchQuery,
      );
      expect(result.current.setSortBy).toBe(mockProductFiltersReturn.setSortBy);
      expect(result.current.setSortOrder).toBe(
        mockProductFiltersReturn.setSortOrder,
      );
    });
  });
