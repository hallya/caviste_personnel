...
describe("IntroText", () => {
  ...
  it("renders content correctly", () => {
    ...
    expect(
      screen.getByText("Un vin, un visage. Une bouteille, une histoire."),
    ).toBeInTheDocument();
    expect(
      screen.getByText(/Chez Edouard, chaque vin est choisi avec soin/),
    ).toBeInTheDocument();
    expect(
      screen.getByText(
        /Des cuvées confidentielles, issues de petites parcelles/,
      ),
    ).toBeInTheDocument();
  });
