export const ORGANIZATION_SCHEMA = {
  ...
  description:
    "Caviste personnel spécialisé dans les vins de vignerons français. Conseils personnalisés, formations en œnologie et sélection de vins d'exception.",
  contactPoint: {
    "@type": "ContactPoint",
    ...
    itemListElement: [
      {
        ...
        itemOffered: {
          ...
          description:
            "Apprenez les bases de la dégustation : vue, odorat, goût. Développez votre vocabulaire œnologique et identifiez les arômes.",
          provider: {
            "@type": "Organization",
            name: "Edouard, Caviste personnel",
          },
      ...
      },
      {
        ...
        itemOffered: {
          ...
          description:
            "Voyage à travers les régions viticoles françaises. Comprenez l'influence du terroir sur le caractère des vins.",
          provider: {
            "@type": "Organization",
            name: "Edouard, Caviste personnel",
          },
      ...
      },
      {
        ...
        itemOffered: {
          ...
          description:
            "Maîtrisez l'art des accords. Apprenez à associer vins et mets pour sublimer vos repas.",
          provider: {
            "@type": "Organization",
            name: "Edouard, Caviste personnel",
          },
...
export const WEBSITE_SCHEMA = {
  ...
  potentialAction: {
    ...
    target: {
      "@type": "EntryPoint",
      urlTemplate:
        "https://caviste-personnel.vercel.app/search?q={search_term_string}",
    },
