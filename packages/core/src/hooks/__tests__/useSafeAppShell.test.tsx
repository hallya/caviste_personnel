...
function TestComponent() {
  ...
  return (
    <div>
      <div data-testid="register-available">
        {typeof appShell.registerModule}
      </div>
      ...
      <div data-testid="is-loaded-available">
        {typeof appShell.isModuleLoaded}
      </div>
    </div>
  );
}
...
describe("useSafeAppShell", () => {
  it("provides safe fallback when used outside AppShell", () => {
    ...
    expect(screen.getByTestId("register-available")).toHaveTextContent(
      "function",
    );
    expect(screen.getByTestId("get-module-available")).toHaveTextContent(
      "function",
    );
    expect(screen.getByTestId("get-api-available")).toHaveTextContent(
      "function",
    );
    expect(screen.getByTestId("is-loaded-available")).toHaveTextContent(
      "function",
    );
  });
